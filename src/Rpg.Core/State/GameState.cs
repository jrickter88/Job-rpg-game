...
public sealed record GameState
{
    ...
    /// A list supports the planned four-member party while allowing the game to begin with
    /// only James; future party-management rules will own the maximum-size decision.
    /// </summary>
